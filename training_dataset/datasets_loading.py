...
def add_period_to_sentences(sentences: List[str]) -> List[str]:
    """
    Adds a period at the end of each string in the provided list of sentences if it doesn't already end with one.

    Args:
        sentences (List[str]): A list of sentences to be updated.

    Returns:
        List[str]: A new list of sentences with periods added at the end where necessary.
    """
    updated_sentences = []
