...
To translate, follow the steps below:
   ...
   **EXAMPLE**
         ...
         {
            "sentence" : "This is a translated sentence."
         }

   **END OF EXAMPLE**

To sum up, your task is to translate a sentence from English to Serbian language, adhiring to the rules of Serbian language and grammar.
The translation must be natural-sounding in Serbian. The output must be a valid JSON format.
"""
