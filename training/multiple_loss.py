...
def get_train_and_eval_mnrl_datasets(
    ...
    train_dataset = convert_to_mnrl_hf_dataset(train_df, question_type)
    eval_dataset = convert_to_mnrl_hf_dataset(eval_df, question_type)
...
def get_train_and_eval_cosine_datasets(
    ...
    sanity_check(train_df, eval_df)
    # Convert lists to Hugging Face Datasets
    train_dataset = convert_to_cosine_hf_dataset(train_df, question_type)
    eval_dataset = convert_to_cosine_hf_dataset(eval_df, question_type)
...
def train_a_model(
    ...
    trainer = SentenceTransformerTrainer(
        ...
        train_dataset={
            ...
            "cosine": cosine_train_dataset,
        },
        eval_dataset={
            "mnrl": mnrl_eval_dataset,
            "cosine": cosine_eval_dataset,
        },
        loss={
            "mnrl": mnrl_train_loss,
            "cosine": cosine_train_loss,
        },
